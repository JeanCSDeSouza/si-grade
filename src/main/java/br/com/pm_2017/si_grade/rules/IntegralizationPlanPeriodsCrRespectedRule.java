...
/**
 * If the student has to deliver an integralization plan this rule is than applied to him.
 * This rule checks all the types of curricular grade available through the reflect rule that 
 * points to what type of IntegralizationPlanPeriodsCrRespectedRule is necessary at the execution time   
 *
 */
public class IntegralizationPlanPeriodsCrRespectedRule implements Rule{
	...
	/**
	 * Execute the call to the ReflectedRule that then makes reflection in the rule that applies to the 
	 * student passed.
	 * @param Student
