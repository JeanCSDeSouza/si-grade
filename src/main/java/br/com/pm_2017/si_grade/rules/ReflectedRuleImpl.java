...
/**
 *implements the refelxion required to instantiate a rule that is 
 *only known if it will be used in execution time
 */
public class ReflectedRuleImpl implements ReflectedRule{
	...
	/**
	 * Generate a class that implements Rule class based on the student year and the name 
	 * passed
	 * @param student A valid student
	 * @param className a valid name of an instantiable class. 
