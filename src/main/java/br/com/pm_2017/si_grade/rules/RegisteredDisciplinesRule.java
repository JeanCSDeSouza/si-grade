...
/**
 * Checks if a student is registered in more than 3 disciplines. To do so needs
 * to check if the student has more than 3 disciplines to attend.
 */
public class RegisteredDisciplinesRule implements Rule {
	/**
	 * Checks if a student is attending more than the
	 * StudentFieldsConstants.REMAINING_DISCIPLINES_INFERIOR_LIMIT.
	 * <p>
	 * 
	 * @param Student
	 * @return true if the student is attending more than the inferior limit or is
	 *         has less than 3 disciplines to attend
	 */
	public boolean execute(Student student) {
		...
		if (hasAtLeast3Remaining(student))
			return (student.attending() >= StudentFieldsConstants.REMAINING_DISCIPLINES_INFERIOR_LIMIT.getValue())
					? true
					: false;
	...
	public boolean hasAtLeast3Remaining(Student student) {
		return (student.remaining() >= StudentFieldsConstants.REMAINING_DISCIPLINES_INFERIOR_LIMIT.getValue()) ? true
				: false;
	}
