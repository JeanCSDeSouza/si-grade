...
/**
 * Implements the IntegralizationPlanPeriodsCrRespectedRule for the 2014
 * curriculum
 */
public class IntegralizationPlanPeriodsCrRespectedRule implements Rule {
	/**
	 * Checks if the student has attended to more then 7 periods and if the cr of
	 * those periods are greater than 5.0
	 */
