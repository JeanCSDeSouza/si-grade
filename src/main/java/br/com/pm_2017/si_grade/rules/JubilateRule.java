...
public class JubilateRule implements Rule {
	 ...
	 * in the previous calls to hasDisciplineFailedMoreThanFailLimit and
	 * isCraLessThanCraLimit that are private members of this class
	 * 
	 * @param student
	 * @return
	 */
	public boolean isJubilate(Student student) {
		...
		return (isCraLessThanCraLimit(student.getCra())
				& hasDisciplineFailedMoreThanFailLimit(student.getDisciplines()));
	}
